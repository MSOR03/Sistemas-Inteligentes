# -*- coding: utf-8 -*-
"""
RIVAL DE PRUEBA - Lexicografico  (interfaz `compute`)

Juega el primer candidato que queda en orden. Es la misma logica que el
`AgenteEstrategico` del notebook y que Cruceta/AgentA de `examples/`, y sirve
de suelo: cualquier agente serio deberia ganarle.

NO es el agente que se entrega. Esta aqui solo para montar torneos locales:
al dejar el archivo junto al notebook, su clase aparece en los desplegables.
"""
...
class RivalLexicografico(_Base):
    """Primer intento 0123 y despues siempre el primer candidato en orden."""
